...
class globalNet(nn.Module):
    def __init__(self, channel_settings, stride_settings, num_class):
        super(globalNet, self).__init__()
        self.channel_settings = channel_settings
        self.stride_settings = stride_settings
        laterals, upsamples, predict = [], [], []
        for i in range(len(channel_settings)):
            laterals.append(self._lateral(channel_settings[i]))
         
            predict.append(self._predict(stride_settings[i], num_class))
    ...
    def _predict(self, stride, num_class):
        layers = []
